 ...
 * seconds ({@code eventflow.cache.dashboard-stats-ttl-seconds}) rather than
...
public class DashboardStatsService {
    ...
    private DashboardStatsResponse computeStats() {
        ...
        return new DashboardStatsResponse(queueDepth, totalReceived, processed, failed, deadLettered, duplicate, totalRetries);
    }

    private long getQueueDepth() {
        QueueInformation info = amqpAdmin.getQueueInfo(rabbitMqProperties.queue());
