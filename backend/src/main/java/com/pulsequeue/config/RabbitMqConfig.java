...
public class RabbitMqConfig {
    ...
    /**
     * Spring Boot's auto-configured {@code RabbitTemplate} and the default
     * {@code rabbitListenerContainerFactory} both look up a single
     * {@code MessageConverter} bean and apply it automatically — defining our
     * own {@code RabbitTemplate}/{@code AmqpTemplate} bean here would collide
     * with the auto-configured one (same bean name, and bean-definition
     * overriding is disabled by default since Spring Boot 2.1).
     */
    @Bean
